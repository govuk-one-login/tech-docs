    ...
    HTMLProofer.check_directory(config[:build_dir],
      { :assume_extension => true,
        ...
        :ignore_urls => [
            ...
            "https://onelogingovuk.service-now.com/csm?id=csm_sc_cat_item&sys_id=83902cb51b4822900a549978b04bcbed"  # ServiceNow contact us form which is slow to load and causes a timeout (requests take over 10 seconds)
        ],
